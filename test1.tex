...
\begin{tikzpicture}
  ...
  \Shoumon@Box@A@P{2}\Shoumon@Box@A{3}{2}\Shoumon@Box@A@P{2}\Shoumon@Box@A{5}{2}\Shoumon@Box@A@P{2}\Shoumon@Box@A{3}{2}\GoDown{2}\Shoumon@Box@A@P{3}\Shoumon@Grid@A{50}[38]
\end{tikzpicture}
\end{document}
