...
\begin{tikzpicture}
  ...
  \Shoumon@Box@A@N{2}\Shoumon@Box@A{3}{2}\Shoumon@Box@A@N{2}\Shoumon@Box@A{5}{2}\Shoumon@Box@A@N{2}\Shoumon@Box@A{3}{2}\GoDown{2}\Shoumon@Box@A@N{3}\Shoumon@NonGrid@A{45}
\end{tikzpicture}
\end{document}
